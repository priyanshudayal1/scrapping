...
import legacy_judgements-test-final
...
def run_scraping_process():
    ...
    try:
        ...
        legacy_judgements-test-final.main()
...
def stop_scraping():
    ...
    try:
        # Note: Graceful shutdown would require modifications to legacy_judgements-test-final.py
